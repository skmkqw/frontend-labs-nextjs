...
export default function ScrabbleBoard({
    ...
    <div className="rounded-2xl border border-zinc-200 bg-white p-3 shadow-sm">
      <div
        className="max-w-full overflow-auto rounded-xl border border-zinc-100 bg-amber-50/40 p-2"
      >
        <div
          className="grid gap-1"
          style={{
            gridTemplateColumns: `36px repeat(${BOARD_SIZE}, ${CELL_SIZE}px)`,
            width: "max-content",
          }}
        >
          <div />
              ...
              {columnHeaders.map((column, colIndex) => {
                ...
                return (
                  <div
                    ...
                    className={clsx(
                      "relative flex items-center justify-center rounded-md border text-base font-semibold uppercase transition",
                      tileLetter
